[anima](../../index.md) / [io.anima.owl](../index.md) / [OwlMainVerticle](./index.md)

# OwlMainVerticle

`class OwlMainVerticle : `[`AnimaVerticle`](../../io.anima/-anima-verticle/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `OwlMainVerticle()` |
