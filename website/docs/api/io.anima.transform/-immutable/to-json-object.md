[anima](../../index.md) / [io.anima.transform](../index.md) / [Immutable](index.md) / [toJsonObject](./to-json-object.md)
...
You should only rely on it if your [Immutable](index.md) implementation just contains primitive transform types,
